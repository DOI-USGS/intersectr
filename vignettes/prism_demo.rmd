...
area_weights <- calculate_area_intersection_weights_2(
  data_source_cells,
  target_polygons)
# 
# target_polygons %>%
...
intersected[, 2:ncol(intersected)] <- intersected[, 2:ncol(intersected)] / 100
...
grid_data <- var.get.nc(nc, variable_name,
                        ...
                        count = c(length(col_inds), length(row_inds), 1)) / 100
